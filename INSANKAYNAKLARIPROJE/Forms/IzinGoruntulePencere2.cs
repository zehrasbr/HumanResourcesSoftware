...
namespace INSANKAYNAKLARIPROJE.Forms
{
    public partial class IzinGoruntulePencere2 : Form
    {
        ...
        private void IzinGoruntulePencere2_Load(object sender, EventArgs e)
        {
            ListeleDepartman();
            txt_TC.Text = IzinleriGoruntule.TC.ToString();
            txt_Adi.Text = IzinleriGoruntule.ADI.ToString();
            txt_Soyadi.Text = IzinleriGoruntule.SOYADI.ToString();
            cbx_departmani.Text = IzinleriGoruntule.DEPARTMANI.ToString();
            txt_adres.Text = IzinleriGoruntule.IZIN_ADRESI.ToString();
            cbx_izinturu.Text = IzinleriGoruntule.IZIN_TURU.ToString();
            dtp_izinbaslangic.Text = IzinleriGoruntule.BASLANGIC_TARIHI.ToString();
            dtp_izinbitis.Text = IzinleriGoruntule.BITIS_TARIHI.ToString();
        }
    }
}
